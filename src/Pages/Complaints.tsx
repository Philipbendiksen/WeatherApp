...
function Complaints() {
    return (
      <div className="flex flex-col">
        ...
        <button
        type="submit"
        className=" items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-slate-500 hover:backdrop:bg-slate-700">Skicka</button>
      </div>
    );
  }
